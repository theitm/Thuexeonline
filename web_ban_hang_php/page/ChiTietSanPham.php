...
$truyvan_laySanPhamLQ=mysqli_query($laySanPhamLQ);

$layDG="SELECT * FROM danhgia WHERE MaSanPham='".$cot["MaSanPham"]."'";
$truyvan_layDG=mysqli_query($layDG);
...
if(isset($_SESSION["tendangnhap"])) {
    ...
    $truyvanlayDG_ND=mysqli_query($layDG_ND);
...
$truyvan_layBinhLuan=mysqli_query($layBinhLuan);
